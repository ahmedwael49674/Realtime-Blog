...
@section('content')
  <div class="container">
    ...
    <button style="float:right" onclick="event.preventDefault();
                     document.getElementById('delete-post-form').submit();" class="btn btn-lg btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> </button>
