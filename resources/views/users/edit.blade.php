...
<div class="container">
    <h1>edit Account</h1>
    <hr />
    <form method="post" action="{{ route('users.update') }}" id="update-account" enctype="multipart/form-data">
        {{ method_field('put') }} 
        {{ csrf_field() }}
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="email" placeholder="E-mail" value="{{ $user->email }}"
                        name="email" required>
                </div>
                ...
                <div class="form-group" id="imageEdit" style="display:none;">
                    <input id="file-demo" type="file" class="file" name="image" multiple=true
